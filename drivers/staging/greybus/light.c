				   ...
				   struct led_classdev *cdev)
{
	...
	{
		typeof((*channel->attrs)) __uncontained_tmp161;
	...
	channel->attr_groups = kcalloc(2, sizeof(*channel->attr_groups),
				       GFP_KERNEL);
	{
		typeof((*channel->attr_groups)) __uncontained_tmp162;
...
static int gb_lights_light_config(struct gb_lights *glights, u8 id)
{
	...
	{
		struct gb_channel __uncontained_tmp159;
...
static int gb_lights_create_all(struct gb_lights *glights)
{
	...
	{
		struct gb_light __uncontained_tmp160;
