...
static int load_video_binaries(struct ia_css_pipe *pipe)
{
	...
	if (need_scaler) {
		...
		mycs->yuv_scaler_binary = kcalloc(cas_scaler_descr.num_stage,
						  ...
						  GFP_KERNEL);
		{
			struct ia_css_binary __uncontained_tmp286;
    ...
    struct ia_css_pipe *pipe)
{
	...
	if (need_extra_yuv_scaler) {
		...
		mycs->yuv_scaler_binary = kcalloc(cas_scaler_descr.num_stage,
						  ...
						  GFP_KERNEL);
		{
			struct ia_css_binary __uncontained_tmp288;
	    ...
	    struct ia_css_cas_binary_descr *descr)
{
	...
	descr->in_info = kmalloc(descr->num_stage *
				 ...
				 GFP_KERNEL);
	{
		struct ia_css_frame_info __uncontained_tmp116;
	...
	descr->internal_out_info = kmalloc(descr->num_stage *
					   ...
					   GFP_KERNEL);
	{
		struct ia_css_frame_info __uncontained_tmp117;
	...
	descr->out_info = kmalloc(descr->num_stage *
				  ...
				  GFP_KERNEL);
	{
		struct ia_css_frame_info __uncontained_tmp118;
	...
	descr->vf_info = kmalloc(descr->num_stage *
				 ...
				 GFP_KERNEL);
	{
		struct ia_css_frame_info __uncontained_tmp119;
				   ...
				   struct ia_css_cas_binary_descr *descr)
{
	...
	descr->internal_out_info = kmalloc(descr->num_stage *
					   ...
					   GFP_KERNEL);
	{
		struct ia_css_frame_info __uncontained_tmp121;
	...
	descr->out_info = kmalloc(descr->num_stage *
				  ...
				  GFP_KERNEL);
	{
		struct ia_css_frame_info __uncontained_tmp122;
	...
	descr->vf_info = kmalloc(descr->num_stage *
				 ...
				 GFP_KERNEL);
	{
		struct ia_css_frame_info __uncontained_tmp123;
...
load_yuvpp_binaries(struct ia_css_pipe *pipe)
{
	...
	if (need_scaler) {
		...
		mycs->yuv_scaler_binary = kcalloc(cas_scaler_descr.num_stage,
						  ...
						  GFP_KERNEL);
		{
			struct ia_css_binary __uncontained_tmp290;
	...
	mycs->vf_pp_binary = kcalloc(mycs->num_vf_pp,
				     ...
				     GFP_KERNEL);
	{
		struct ia_css_binary __uncontained_tmp292;
		     ...
		     struct ia_css_stream **stream)
{
	...
	{
		struct ia_css_pipe *__uncontained_tmp293;
