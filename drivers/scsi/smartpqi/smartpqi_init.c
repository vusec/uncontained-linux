...
again:
	...
	{
		struct report_lun_header __uncontained_tmp57;
...
static inline int pqi_report_phys_luns(struct pqi_ctrl_info *ctrl_info, void **buffer)
{
	...
	{
		struct report_lun_header __uncontained_tmp58;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp58;
	}
	{
		struct report_phys_lun_16byte_wwid __uncontained_tmp59;
	...
	struct report_log_lun_list **logdev_list)
{
	...
	{
		struct report_lun_header __uncontained_tmp60;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp60;
	}
	{
		struct report_log_lun __uncontained_tmp84;
