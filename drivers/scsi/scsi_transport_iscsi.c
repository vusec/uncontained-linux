		   ...
		   uint32_t iface_type, uint32_t iface_num, int dd_size)
{
	...
	{
		typeof((*iface)) __uncontained_tmp33;
			    ...
			    int dd_size)
{
	...
	{
		typeof((*fnode_sess)) __uncontained_tmp34;
			    ...
			    int dd_size)
{
	...
	{
		typeof((*fnode_conn)) __uncontained_tmp35;
		    ...
		    int dd_size)
{
	...
	session = kzalloc(sizeof(*session) + dd_size,
			  GFP_KERNEL);
	{
		typeof((*session)) __uncontained_tmp36;
...
iscsi_create_conn(struct iscsi_cls_session *session, int dd_size, uint32_t cid)
{
	...
	{
		typeof((*conn)) __uncontained_tmp37;
