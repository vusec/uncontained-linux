		...
		uint16_t sa_index, uint16_t handle)
{
	...
	{
		struct edif_list_entry __uncontained_tmp117;
...
qla_edif_app_getfcinfo(scsi_qla_host_t *vha, struct bsg_job *bsg_job)
{
	...
	{
		struct app_pinfo __uncontained_tmp118;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp118;
	}
	{
		struct app_pinfo_reply __uncontained_tmp119;
...
qla_edif_app_getstats(scsi_qla_host_t *vha, struct bsg_job *bsg_job)
{
	...
	{
		struct app_sinfo __uncontained_tmp67;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp67;
	}
	{
		struct app_stats_reply __uncontained_tmp68;
		...
		struct qla_sa_update_frame *sa_frame)
{
	...
	if (!entry) {
		...
		{
			struct edif_sa_index_entry __uncontained_tmp120;
