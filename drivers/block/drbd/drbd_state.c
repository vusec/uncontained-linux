...
static struct drbd_state_change *alloc_state_change(unsigned int n_devices, unsigned int n_connections, gfp_t gfp)
{
	...
	{
		struct drbd_connection_state_change __uncontained_tmp6;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp6;
	}
	{
		struct drbd_device_state_change __uncontained_tmp7;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp7;
	}
	{
		struct drbd_peer_device_state_change __uncontained_tmp8;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp8;
	}
	{
		struct drbd_state_change __uncontained_tmp9;
