...
static int mei_nfc_if_version(struct nfc_mei_phy *phy)
{
	...
	{
		struct mei_nfc_if_version __uncontained_tmp44;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp44;
	}
	{
		struct mei_nfc_reply __uncontained_tmp45;
...
static int mei_nfc_connect(struct nfc_mei_phy *phy)
{
	...
	{
		struct mei_nfc_cmd __uncontained_tmp46;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp46;
	}
	{
		struct mei_nfc_connect __uncontained_tmp47;
	...
	{
		struct mei_nfc_cmd __uncontained_tmp48;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp48;
	}
	{
		struct mei_nfc_connect_resp __uncontained_tmp49;
