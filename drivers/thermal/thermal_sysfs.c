...
static int create_trip_attrs(struct thermal_zone_device *tz, int mask)
{
	...
	tz->trip_type_attrs = kcalloc(tz->trips, sizeof(*tz->trip_type_attrs),
				      GFP_KERNEL);
	{
		typeof((*tz->trip_type_attrs)) __uncontained_tmp239;
	...
	tz->trip_temp_attrs = kcalloc(tz->trips, sizeof(*tz->trip_temp_attrs),
				      GFP_KERNEL);
	{
		typeof((*tz->trip_temp_attrs)) __uncontained_tmp240;
	...
	if (tz->ops->get_trip_hyst) {
		tz->trip_hyst_attrs = kcalloc(tz->trips,
					      ...
					      GFP_KERNEL);
		{
			typeof((*tz->trip_hyst_attrs)) __uncontained_tmp241;
	...
	{
		typeof((*attrs)) __uncontained_tmp242;
				      ...
				      int mask)
{
	...
	{
		typeof((*groups)) __uncontained_tmp243;
