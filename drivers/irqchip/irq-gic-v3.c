...
static void gic_enable_nmi_support(void)
{
	...
	{
		typeof((*ppi_nmi_refs)) __uncontained_tmp116;
...
static void __init gic_populate_ppi_partitions(struct device_node *gic_node)
{
	...
	{
		typeof((*gic_data.ppi_descs)) __uncontained_tmp117;
	...
	{
		typeof((*parts)) __uncontained_tmp118;
...
static int __init gic_of_init(struct device_node *node, struct device_node *parent)
{
	...
	rdist_regs = kcalloc(nr_redist_regions, sizeof(*rdist_regs),
			     GFP_KERNEL);
	{
		typeof((*rdist_regs)) __uncontained_tmp119;
...
gic_acpi_init(union acpi_subtable_headers *header, const unsigned long end)
{
	...
	{
		typeof((*acpi_data.redist_regs)) __uncontained_tmp21;
