...
hdm_probe(struct usb_interface *interface, const struct usb_device_id *id)
{
	...
	{
		typeof((*mdev->conf)) __uncontained_tmp124;
	...
	{
		typeof((*mdev->cap)) __uncontained_tmp125;
	...
	{
		typeof((*mdev->ep_address)) __uncontained_tmp126;
	...
	{
		typeof((*mdev->busy_urbs)) __uncontained_tmp127;
