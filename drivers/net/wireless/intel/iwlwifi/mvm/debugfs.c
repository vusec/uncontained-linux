					  ...
					  loff_t *ppos)
{
	...
	{
		typeof((__le32)) __uncontained_tmp36;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp36;
	}
	{
		struct mvm_statistics_rx __uncontained_tmp33;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp33;
	}
	{
		struct mvm_statistics_rx_v3 __uncontained_tmp34;
				   ...
				   loff_t *ppos)
{
	...
	{
		typeof((*cmd)) __uncontained_tmp37;
