...
static struct scatterlist *alloc_sgtable(int size)
{
	...
	{
		typeof((*table)) __uncontained_tmp101;
			    ...
			    const struct iwl_dump_ini_mem_ops *ops)
{
	...
	{
		typeof((*entry)) __uncontained_tmp26;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp26;
	}
	{
		typeof((*tlv)) __uncontained_tmp27;
			     ...
			     struct list_head *list)
{
	...
	{
		typeof((*entry)) __uncontained_tmp28;
				 ...
				 struct list_head *list)
{
	...
	{
		typeof((*entry)) __uncontained_tmp29;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp29;
	}
	{
		typeof((*hdr)) __uncontained_tmp30;
		       ...
		       struct iwl_fw_dbg_trigger_tlv *trigger)
{
	...
	{
		typeof((*desc)) __uncontained_tmp25;
