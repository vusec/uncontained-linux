			    ...
			    const struct iwl_dump_ini_mem_ops *ops)
{
	...
	{
		typeof((*entry)) __uncontained_tmp87;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp87;
	}
	{
		typeof((*tlv)) __uncontained_tmp88;
			     ...
			     struct list_head *list)
{
	...
	{
		typeof((*entry)) __uncontained_tmp89;
				 ...
				 struct list_head *list)
{
	...
	{
		typeof((*entry)) __uncontained_tmp90;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp90;
	}
	{
		typeof((*hdr)) __uncontained_tmp91;
		       ...
		       struct iwl_fw_dbg_trigger_tlv *trigger)
{
	...
	{
		typeof((*desc)) __uncontained_tmp86;
