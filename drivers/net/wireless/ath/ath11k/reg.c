...
int ath11k_regd_update(struct ath11k *ar)
{
	...
	{
		typeof((*regd)) __uncontained_tmp60;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp60;
	}
	{
		struct ieee80211_reg_rule __uncontained_tmp59;
		      ...
		      struct ieee80211_regdomain *curr_regd)
{
	...
	new_regd = kzalloc(sizeof(*new_regd) + (num_new_regd_rules *
			...
			GFP_ATOMIC);
	{
		typeof((*new_regd)) __uncontained_tmp86;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp86;
	}
	{
		struct ieee80211_reg_rule __uncontained_tmp84;
		      ...
		      struct cur_regulatory_info *reg_info, bool intersect)
{
	...
	tmp_regd =  kzalloc(sizeof(*tmp_regd) +
			...
			GFP_ATOMIC);
	{
		typeof((*tmp_regd)) __uncontained_tmp87;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp87;
	}
	{
		struct ieee80211_reg_rule __uncontained_tmp85;
