...
static int ixgbevf_set_interrupt_capability(struct ixgbevf_adapter *adapter)
{
	...
	{
		struct msix_entry __uncontained_tmp183;
				  ...
				  int rxr_count, int rxr_idx)
{
	...
	{
		typeof((*q_vector)) __uncontained_tmp54;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp54;
	}
	{
		typeof((*ring)) __uncontained_tmp55;
...
int ixgbevf_setup_tx_resources(struct ixgbevf_ring *tx_ring)
{
	...
	{
		struct ixgbevf_tx_buffer __uncontained_tmp52;
			       ...
			       struct ixgbevf_ring *rx_ring)
{
	...
	{
		struct ixgbevf_rx_buffer __uncontained_tmp53;
