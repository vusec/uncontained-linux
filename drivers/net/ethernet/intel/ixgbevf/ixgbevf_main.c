				  ...
				  int rxr_count, int rxr_idx)
{
	...
	{
		typeof((*q_vector)) __uncontained_tmp26;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp26;
	}
	{
		typeof((*ring)) __uncontained_tmp27;
...
int ixgbevf_setup_tx_resources(struct ixgbevf_ring *tx_ring)
{
	...
	{
		struct ixgbevf_tx_buffer __uncontained_tmp24;
			       ...
			       struct ixgbevf_ring *rx_ring)
{
	...
	{
		struct ixgbevf_rx_buffer __uncontained_tmp25;
