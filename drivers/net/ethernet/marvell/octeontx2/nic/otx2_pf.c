...
int otx2_open(struct net_device *netdev)
{
	...
	{
		typeof((*cq_poll)) __uncontained_tmp76;
	...
	{
		struct otx2_cq_queue __uncontained_tmp73;
	...
	{
		struct otx2_snd_queue __uncontained_tmp74;
	...
	{
		struct otx2_rcv_queue __uncontained_tmp75;
