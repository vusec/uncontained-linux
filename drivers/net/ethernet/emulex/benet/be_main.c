...
static int be_vf_setup_init(struct be_adapter *adapter)
{
	...
	adapter->vf_cfg = kcalloc(adapter->num_vfs, sizeof(*vf_cfg),
				  GFP_KERNEL);
	{
		typeof((*vf_cfg)) __uncontained_tmp65;
...
static int be_if_create(struct be_adapter *adapter)
{
	...
	{
		typeof((*adapter->pmac_id)) __uncontained_tmp66;
	...
	{
		typeof((*adapter->mc_list)) __uncontained_tmp67;
	...
	{
		typeof((*adapter->uc_list)) __uncontained_tmp68;
