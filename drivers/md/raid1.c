...
static struct r1conf *setup_conf(struct mddev *mddev)
{
	...
	{
		typeof((atomic_t)) __uncontained_tmp68;
	...
	conf->nr_waiting = kcalloc(BARRIER_BUCKETS_NR,
				   sizeof(atomic_t), GFP_KERNEL);
	{
		typeof((atomic_t)) __uncontained_tmp69;
	...
	conf->nr_queued = kcalloc(BARRIER_BUCKETS_NR,
				  sizeof(atomic_t), GFP_KERNEL);
	{
		typeof((atomic_t)) __uncontained_tmp70;
	...
	conf->barrier = kcalloc(BARRIER_BUCKETS_NR,
				sizeof(atomic_t), GFP_KERNEL);
	{
		typeof((atomic_t)) __uncontained_tmp71;
	...
	conf->mirrors = kzalloc(array3_size(sizeof(struct raid1_info),
				...
				GFP_KERNEL);
	{
		struct raid1_info __uncontained_tmp10;
	...
	{
		typeof((*conf->poolinfo)) __uncontained_tmp13;
...
static int raid1_reshape(struct mddev *mddev)
{
	...
	{
		typeof((*newpoolinfo)) __uncontained_tmp12;
	...
	newmirrors = kzalloc(array3_size(sizeof(struct raid1_info),
			     ...
			     GFP_KERNEL);
	{
		struct raid1_info __uncontained_tmp11;
