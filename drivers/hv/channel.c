...
static int send_modifychannel_with_ack(struct vmbus_channel *channel, u32 target_vp)
{
	...
	info = kzalloc(sizeof(struct vmbus_channel_msginfo) +
		       ...
		       GFP_KERNEL);
	{
		struct vmbus_channel_modifychannel __uncontained_tmp17;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp17;
	}
	{
		struct vmbus_channel_msginfo __uncontained_tmp18;
		       ...
		       void (*onchannelcallback)(void *context), void *context)
{
	...
	open_info = kzalloc(sizeof(*open_info) +
			   ...
			   GFP_KERNEL);
	{
		typeof((*open_info)) __uncontained_tmp21;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp21;
	}
	{
		struct vmbus_channel_open_channel __uncontained_tmp19;
...
int vmbus_teardown_gpadl(struct vmbus_channel *channel, struct vmbus_gpadl *gpadl)
{
	...
	{
		typeof((*info)) __uncontained_tmp22;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp22;
	}
	{
		struct vmbus_channel_gpadl_teardown __uncontained_tmp20;
