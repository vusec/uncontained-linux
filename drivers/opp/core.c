		...
		const char * const *names, struct device ***virt_devs)
{
	...
	opp_table->genpd_virt_devs = kcalloc(opp_table->required_opp_count,
					     ...
					     GFP_KERNEL);
	{
		typeof((*opp_table->genpd_virt_devs)) __uncontained_tmp212;
