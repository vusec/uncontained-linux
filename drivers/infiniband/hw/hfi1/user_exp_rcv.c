			   ...
			   struct hfi1_ctxtdata *uctxt)
{
	...
	fd->entry_to_rb = kcalloc(uctxt->expected_count,
				  ...
				  GFP_KERNEL);
	{
		struct rb_node *__uncontained_tmp54;
	...
	if (!HFI1_CAP_UGET_MASK(uctxt->flags, TID_UNMAP)) {
		...
		fd->invalid_tids = kcalloc(uctxt->expected_count,
					   ...
					   GFP_KERNEL);
		{
			typeof((*fd->invalid_tids)) __uncontained_tmp55;
...
static int pin_rcv_pages(struct hfi1_filedata *fd, struct tid_user_buf *tidbuf)
{
	...
	{
		typeof((*pages)) __uncontained_tmp56;
			    ...
			    struct hfi1_tid_info *tinfo)
{
	...
	tidbuf->psets = kcalloc(uctxt->expected_count, sizeof(*tidbuf->psets),
				GFP_KERNEL);
	{
		typeof((*tidbuf->psets)) __uncontained_tmp57;
	...
	{
		typeof((*tidlist)) __uncontained_tmp58;
			      ...
			      struct hfi1_tid_info *tinfo)
{
	...
	{
		typeof((*array)) __uncontained_tmp59;
