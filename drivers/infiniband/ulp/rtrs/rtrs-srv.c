...
static int rtrs_srv_alloc_ops_ids(struct rtrs_srv_path *srv_path)
{
	...
	srv_path->ops_ids = kcalloc(srv->queue_depth,
				    ...
				    GFP_KERNEL);
	{
		typeof((*srv_path->ops_ids)) __uncontained_tmp49;
...
static int map_cont_bufs(struct rtrs_srv_path *srv_path)
{
	...
	{
		typeof((*srv_path->mrs)) __uncontained_tmp50;
			    ...
			    struct rtrs_msg_info_req *msg)
{
	...
	{
		typeof((*rwr)) __uncontained_tmp51;
					  ...
					  bool first_conn)
{
	...
	srv->chunks = kcalloc(srv->queue_depth, sizeof(*srv->chunks),
			      GFP_KERNEL);
	{
		typeof((*srv->chunks)) __uncontained_tmp52;
					   ...
					   const uuid_t *uuid)
{
	...
	srv_path->dma_addr = kcalloc(srv->queue_depth,
				     ...
				     GFP_KERNEL);
	{
		typeof((*srv_path->dma_addr)) __uncontained_tmp53;
	...
	srv_path->s.con = kcalloc(con_num, sizeof(*srv_path->s.con),
				  GFP_KERNEL);
	{
		typeof((*srv_path->s.con)) __uncontained_tmp54;
