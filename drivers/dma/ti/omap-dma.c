	...
	size_t period_len, enum dma_transfer_direction dir, unsigned long flags)
{
	...
	{
		typeof((*d)) __uncontained_tmp11;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp11;
	}
	{
		typeof((d->sg[0])) __uncontained_tmp12;
	...
	size_t len, unsigned long tx_flags)
{
	...
	d = kzalloc(sizeof(*d) + sizeof(d->sg[0]), GFP_ATOMIC);
	{
		typeof((*d)) __uncontained_tmp13;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp13;
	}
	{
		typeof((d->sg[0])) __uncontained_tmp14;
	...
	unsigned long flags)
{
	...
	d = kzalloc(sizeof(*d) + sizeof(d->sg[0]), GFP_ATOMIC);
	{
		typeof((*d)) __uncontained_tmp15;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp15;
	}
	{
		typeof((d->sg[0])) __uncontained_tmp16;
