...
static struct d40_base * __init d40_hw_detect_init(struct platform_device *pdev)
{
	...
	{
		struct d40_base __uncontained_tmp25;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp25;
	}
	{
		struct d40_chan __uncontained_tmp26;
	...
	base->phy_res = kcalloc(num_phy_chans,
				...
				GFP_KERNEL);
	{
		typeof((*base->phy_res)) __uncontained_tmp47;
	...
	base->lookup_phy_chans = kcalloc(num_phy_chans,
					 ...
					 GFP_KERNEL);
	{
		typeof((*base->lookup_phy_chans)) __uncontained_tmp48;
	...
	base->lookup_log_chans = kcalloc(num_log_chans,
					 ...
					 GFP_KERNEL);
	{
		typeof((*base->lookup_log_chans)) __uncontained_tmp49;
	...
	base->lcla_pool.alloc_map = kcalloc(num_phy_chans
					    * D40_LCLA_LINK_PER_EVENT_GRP,
					    ...
					    GFP_KERNEL);
	{
		typeof((*base->lcla_pool.alloc_map)) __uncontained_tmp50;
