						  ...
						  int nr_pages)
{
	...
	{
		typeof((*sglist)) __uncontained_tmp20;
					...
					int nr_pages, int offset, size_t size)
{
	...
	{
		typeof((*sglist)) __uncontained_tmp19;
				    ...
				    unsigned long nr_pages)
{
	...
	dma->vaddr_pages = kcalloc(nr_pages, sizeof(*dma->vaddr_pages),
				   GFP_KERNEL);
	{
		typeof((*dma->vaddr_pages)) __uncontained_tmp70;
	...
	{
		typeof((*dma->dma_addr)) __uncontained_tmp71;
...
static struct videobuf_buffer *__videobuf_alloc_vb(size_t size)
{
	...
	{
		typeof((*mem)) __uncontained_tmp18;
