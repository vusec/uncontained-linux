		...
		unsigned int num_pads, unsigned int extra_size)
{
	...
	{
		typeof((*entity)) __uncontained_tmp24;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp24;
	}
	{
		typeof((*entity->pads)) __uncontained_tmp25;
