...
static int cfg80211_conn_scan(struct wireless_dev *wdev)
{
	...
	request = kzalloc(sizeof(*request) + sizeof(request->ssids[0]) +
			  ...
			  GFP_KERNEL);
	{
		typeof((*request)) __uncontained_tmp161;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp161;
	}
	{
		typeof((request->channels[0])) __uncontained_tmp162;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp162;
	}
	{
		typeof((request->ssids[0])) __uncontained_tmp163;
			   ...
			   gfp_t gfp)
{
	...
	{
		typeof((*ev)) __uncontained_tmp164;
		     ...
		     gfp_t gfp)
{
	...
	{
		typeof((*ev)) __uncontained_tmp165;
			   ...
			   bool locally_generated, gfp_t gfp)
{
	...
	{
		typeof((*ev)) __uncontained_tmp166;
