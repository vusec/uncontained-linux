						     ...
						     void __user *useraddr)
{
	...
	{
		typeof((indir[0])) __uncontained_tmp163;
						     ...
						     void __user *useraddr)
{
	...
	indir = kcalloc(dev_size, sizeof(indir[0]), GFP_USER);
	{
		typeof((indir[0])) __uncontained_tmp164;
...
ethtool_rx_flow_rule_create(const struct ethtool_rx_flow_spec_input *input)
{
	...
	{
		struct ethtool_rx_flow_match __uncontained_tmp108;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp108;
	}
	{
		struct ethtool_rx_flow_rule __uncontained_tmp109;
