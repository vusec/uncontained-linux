...
xfs_init_caches(void)
{
	...
	xfs_efd_cache = kmem_cache_create("xfs_efd_item",
					...
					0, 0, NULL);
	{
		struct xfs_efd_log_item __uncontained_tmp154;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp154;
	}
	{
		struct xfs_extent __uncontained_tmp155;
	...
	xfs_efi_cache = kmem_cache_create("xfs_efi_item",
					 ...
					 0, 0, NULL);
	{
		struct xfs_efi_log_item __uncontained_tmp156;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp156;
	}
	{
		struct xfs_extent __uncontained_tmp157;
