...
int ocfs2_compute_replay_slots(struct ocfs2_super *osb)
{
	...
	{
		char __uncontained_tmp102;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp102;
	}
	{
		struct ocfs2_replay_map __uncontained_tmp103;
...
int ocfs2_recovery_init(struct ocfs2_super *osb)
{
	...
	rm = kzalloc(sizeof(struct ocfs2_recovery_map) +
		     ...
		     GFP_KERNEL);
	{
		unsigned int __uncontained_tmp104;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp104;
	}
	{
		struct ocfs2_recovery_map __uncontained_tmp105;
