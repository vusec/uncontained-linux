		...
		struct nfsd4_getdeviceinfo *gdp)
{
	...
	{
		struct pnfs_block_deviceaddr __uncontained_tmp115;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp115;
	}
	{
		struct pnfs_block_volume __uncontained_tmp116;
		...
		struct nfsd4_getdeviceinfo *gdp)
{
	...
	dev = kzalloc(sizeof(struct pnfs_block_deviceaddr) +
		      sizeof(struct pnfs_block_volume), GFP_KERNEL);
	{
		struct pnfs_block_deviceaddr __uncontained_tmp117;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp117;
	}
	{
		struct pnfs_block_volume __uncontained_tmp118;
