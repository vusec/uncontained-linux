	...
	const char *path, struct ctl_table *table)
{
	...
	{
		struct ctl_node __uncontained_tmp48;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp48;
	}
	{
		struct ctl_table_header __uncontained_tmp49;
	...
	const struct ctl_path *path, struct ctl_table *table)
{
	...
	if (nr_subheaders == 1) {
		...
		{
			typeof((*header)) __uncontained_tmp51;
			__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp51;
		}
		{
			typeof((*subheaders)) __uncontained_tmp52;
