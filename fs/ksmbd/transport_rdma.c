				...
				u32 remote_len, bool is_read)
{
	...
	{
		struct scatterlist __uncontained_tmp138;
...
static int smb_direct_create_pools(struct smb_direct_transport *t)
{
	...
	{
		struct smb_direct_negotiate_resp __uncontained_tmp142;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp142;
	}
	{
		struct smb_direct_sendmsg __uncontained_tmp143;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp143;
	}
	{
		struct smb_direct_negotiate_resp __uncontained_tmp139;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp139;
	}
	{
		struct smb_direct_sendmsg __uncontained_tmp140;
	...
	t->recvmsg_cache = kmem_cache_create(name,
					     ...
					     0, SLAB_HWCACHE_ALIGN, NULL);
	{
		struct smb_direct_recvmsg __uncontained_tmp144;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp144;
	}
	{
		struct smb_direct_recvmsg __uncontained_tmp141;
