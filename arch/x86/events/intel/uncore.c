						 ...
						 int node)
{
	...
	{
		typeof((*box)) __uncontained_tmp10;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp10;
	}
	{
		struct intel_uncore_extra_reg __uncontained_tmp9;
...
static int __init uncore_type_init(struct intel_uncore_type *type, bool setid)
{
	...
	for (i = 0; i < type->num_boxes; i++) {
		...
		{
			struct intel_uncore_box *__uncontained_tmp7;
...
static int __init uncore_pci_init(void)
{
	...
	{
		struct pci_extra_dev __uncontained_tmp8;
