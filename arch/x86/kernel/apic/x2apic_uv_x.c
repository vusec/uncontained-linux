...
static __init void build_uv_gr_table(void)
{
	...
	{
		struct uv_gam_range_s __uncontained_tmp8;
...
static void __init build_socket_tables(void)
{
	...
	{
		typeof((_socket_to_node[0])) __uncontained_tmp10;
	...
	{
		typeof((_pnode_to_socket[0])) __uncontained_tmp11;
	...
	{
		typeof((_node_to_pnode[0])) __uncontained_tmp12;
