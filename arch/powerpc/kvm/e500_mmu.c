			      ...
			      struct kvm_config_tlb *cfg)
{
	...
	{
		typeof((*privs[0])) __uncontained_tmp3;
	...
	{
		typeof((*privs[1])) __uncontained_tmp4;
	...
	g2h_bitmap = kcalloc(params.tlb_sizes[1],
			     ...
			     GFP_KERNEL);
	{
		typeof((*g2h_bitmap)) __uncontained_tmp5;
...
int kvmppc_e500_tlb_init(struct kvmppc_vcpu_e500 *vcpu_e500)
{
	...
	vcpu_e500->gtlb_priv[0] = kcalloc(vcpu_e500->gtlb_params[0].entries,
					  ...
					  GFP_KERNEL);
	{
		struct tlbe_ref __uncontained_tmp1;
	...
	vcpu_e500->gtlb_priv[1] = kcalloc(vcpu_e500->gtlb_params[1].entries,
					  ...
					  GFP_KERNEL);
	{
		struct tlbe_ref __uncontained_tmp2;
	...
	vcpu_e500->g2h_tlb1_map = kcalloc(vcpu_e500->gtlb_params[1].entries,
					  ...
					  GFP_KERNEL);
	{
		typeof((*vcpu_e500->g2h_tlb1_map)) __uncontained_tmp6;
