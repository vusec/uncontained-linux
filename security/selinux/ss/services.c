			       ...
			       struct selinux_map *out_map)
{
	...
	{
		typeof((*out_map->mapping)) __uncontained_tmp146;
			   ...
			   u32 *nel)
{
	...
	*nel = 0;
	...
	{
		typeof((*mysids)) __uncontained_tmp147;
	...
	ebitmap_for_each_positive_bit(&user->roles, rnode, i) {
		...
		ebitmap_for_each_positive_bit(&role->types, tnode, j) {
			...
			if (mynel < maxnel) {
				...
				{
					typeof((*mysids2)) __uncontained_tmp148;
...
out_unlock:
	...
	{
		typeof((*mysids2)) __uncontained_tmp149;
			 ...
			 char ***classes, int *nclasses)
{
	...
	*classes = kcalloc(*nclasses, sizeof(**classes), GFP_ATOMIC);
	{
		typeof((**classes)) __uncontained_tmp150;
			     ...
			     char *class, char ***perms, int *nperms)
{
	...
	*perms = kcalloc(*nperms, sizeof(**perms), GFP_ATOMIC);
	{
		typeof((**perms)) __uncontained_tmp151;
