			     ...
			     struct cond_av_list *other)
{
	...
	{
		typeof((*list->nodes)) __uncontained_tmp147;
...
static int cond_read_node(struct policydb *p, struct cond_node *node, void *fp)
{
	...
	{
		typeof((*node->expr.nodes)) __uncontained_tmp148;
...
int cond_read_list(struct policydb *p, void *fp)
{
	...
	{
		typeof((*p->cond_list)) __uncontained_tmp149;
			...
			struct avtab *avtab)
{
	...
	{
		typeof((*new->nodes)) __uncontained_tmp150;
					...
					struct policydb *origp)
{
	...
	newp->cond_list = kcalloc(origp->cond_list_len,
				...
				GFP_KERNEL);
	{
		typeof((*newp->cond_list)) __uncontained_tmp151;
