...
static void add_sect_attrs(struct module *mod, const struct load_info *info)
{
	...
	{
		typeof((sect_attrs->grp.bin_attrs[0])) __uncontained_tmp73;
		__uncontained_complex_alloc = (unsigned long)&__uncontained_tmp73;
	}
	{
		typeof((sect_attrs->grp.bin_attrs[0])) __uncontained_tmp74;
...
static int module_add_modinfo_attrs(struct module *mod)
{
	...
	mod->modinfo_attrs = kzalloc((sizeof(struct module_attribute) *
					...
					GFP_KERNEL);
	{
		struct module_attribute __uncontained_tmp159;
