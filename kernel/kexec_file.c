...
static int kexec_calculate_store_digests(struct kimage *image)
{
	...
	{
		typeof((*desc)) __uncontained_tmp95;
	...
	{
		struct kexec_sha_region __uncontained_tmp92;
