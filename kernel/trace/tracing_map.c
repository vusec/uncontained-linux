...
static struct tracing_map_elt *tracing_map_elt_alloc(struct tracing_map *map)
{
	...
	{
		typeof((*elt->fields)) __uncontained_tmp304;
	...
	{
		typeof((*elt->vars)) __uncontained_tmp305;
	...
	{
		typeof((*elt->var_set)) __uncontained_tmp306;
			     ...
			     struct tracing_map_sort_entry ***sort_entries)
{
	...
	{
		typeof((sort_entry)) __uncontained_tmp133;
