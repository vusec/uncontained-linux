			  ...
			  bpfptr_t uattr)
{
	...
	{
		typeof((*info_aux)) __uncontained_tmp127;
					    ...
					    const struct bpf_insn *patch, u32 len)
{
	...
	if (len > 1) {
		...
		{
			struct bpf_insn_aux_data __uncontained_tmp53;
...
static int jit_subprogs(struct bpf_verifier_env *env)
{
	...
	{
		typeof((prog)) __uncontained_tmp128;
...
int bpf_check(struct bpf_prog **prog, union bpf_attr *attr, bpfptr_t uattr)
{
	...
	{
		struct bpf_insn_aux_data __uncontained_tmp54;
