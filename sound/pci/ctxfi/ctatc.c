...
static int atc_get_resources(struct ct_atc *atc)
{
	...
	{
		void *__uncontained_tmp351;
		__uncontained_kcalloc = (unsigned long)&__uncontained_tmp351;
	}
	if (!atc->pcm)
		return -ENOMEM;
