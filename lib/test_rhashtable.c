...
static int __init test_rhltable(unsigned int entries)
{
	...
	{
		typeof((*rhl_test_objects)) __uncontained_tmp139;
...
static int __init test_rht_init(void)
{
	...
	{
		struct test_obj __uncontained_tmp136;
	...
	{
		struct thread_data __uncontained_tmp137;
	...
	{
		struct test_obj __uncontained_tmp138;
